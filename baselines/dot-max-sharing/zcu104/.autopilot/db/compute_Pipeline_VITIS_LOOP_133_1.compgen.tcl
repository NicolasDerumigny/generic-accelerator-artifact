...
set name corr_accel_hmul_16ns_16ns_16_2_full_dsp_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {hmul} IMPL {fulldsp} LATENCY 1 ALLOW_PRAGMA 1
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_ret_out \
    op interface \
    ports { ret_out { O 16 vector } ret_out_ap_vld { O 1 bit } } \
} "
}
