...
module corr_accel_compute_Pipeline_VITIS_LOOP_156_5 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg    ap_ready_int;
wire   [63:0] zext_ln160_fu_102_p1;
reg   [6:0] j_6_fu_44;
wire   [6:0] add_ln156_fu_108_p2;
wire    ap_loop_init;
reg   [6:0] ap_sig_allocacmp_j;
wire   [4:0] lshr_ln9_fu_92_p4;
reg    ap_done_reg;
...
always @ (*) begin
    if (((ap_start_int == 1'b1) & (tmp_fu_84_p3 == 1'd1) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if (((ap_start_int == 1'b1) & (tmp_fu_84_p3 == 1'd0) & (1'b1 == ap_CS_fsm_state1))) begin
...
assign add_ln156_fu_108_p2 = (ap_sig_allocacmp_j + 7'd2);
...
assign lshr_ln9_fu_92_p4 = {{ap_sig_allocacmp_j[5:1]}};

assign reg_file_5_0_address0 = zext_ln160_fu_102_p1;

assign reg_file_5_0_d0 = 16'd0;

assign reg_file_5_1_address0 = zext_ln160_fu_102_p1;

assign reg_file_5_1_d0 = 16'd0;

assign tmp_fu_84_p3 = ap_sig_allocacmp_j[32'd6];

assign zext_ln160_fu_102_p1 = lshr_ln9_fu_92_p4;

endmodule //corr_accel_compute_Pipeline_VITIS_LOOP_156_5
