...
attribute shreg_extract : string;
    ...
    signal reg_file_4_0_addr_reg_182 : STD_LOGIC_VECTOR (10 downto 0);
    signal reg_file_4_0_addr_reg_182_pp0_iter1_reg : STD_LOGIC_VECTOR (10 downto 0);
    ...
    signal zext_ln137_fu_148_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal j_5_fu_52 : STD_LOGIC_VECTOR (6 downto 0);
    signal add_ln134_fu_154_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_sig_allocacmp_j : STD_LOGIC_VECTOR (6 downto 0);
    signal lshr_ln_fu_130_p4 : STD_LOGIC_VECTOR (4 downto 0);
    signal add_ln_fu_140_p3 : STD_LOGIC_VECTOR (10 downto 0);
...
begin
    ...
    j_5_fu_52_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((tmp_fu_122_p3 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
                    j_5_fu_52 <= add_ln134_fu_154_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    j_5_fu_52 <= ap_const_lv7_0;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                reg_file_4_0_addr_reg_182_pp0_iter1_reg <= reg_file_4_0_addr_reg_182;
                reg_file_4_1_addr_reg_188_pp0_iter1_reg <= reg_file_4_1_addr_reg_188;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((tmp_fu_122_p3 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                reg_file_4_0_addr_reg_182 <= zext_ln137_fu_148_p1(11 - 1 downto 0);
                reg_file_4_1_addr_reg_188 <= zext_ln137_fu_148_p1(11 - 1 downto 0);
            end if;
        end if;
    end process;
    ...
    add_ln134_fu_154_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_j) + unsigned(ap_const_lv7_2));
    add_ln_fu_140_p3 <= (i & lshr_ln_fu_130_p4);
    ...
    ap_sig_allocacmp_j_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, j_5_fu_52, ap_loop_init)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
            ap_sig_allocacmp_j <= ap_const_lv7_0;
        else 
            ap_sig_allocacmp_j <= j_5_fu_52;
        end if; 
    end process;

    grp_fu_172_p_ce <= ap_const_logic_1;
    grp_fu_172_p_din0 <= reg_file_4_0_q1;
    grp_fu_172_p_din1 <= reg_file_1_0_load;
    grp_fu_176_p_ce <= ap_const_logic_1;
    grp_fu_176_p_din0 <= reg_file_4_1_q1;
    grp_fu_176_p_din1 <= reg_file_1_0_load;
    lshr_ln_fu_130_p4 <= ap_sig_allocacmp_j(5 downto 1);
    reg_file_4_0_address0 <= reg_file_4_0_addr_reg_182_pp0_iter1_reg;
    reg_file_4_0_address1 <= zext_ln137_fu_148_p1(11 - 1 downto 0);
    ...
    reg_file_4_0_d0 <= grp_fu_172_p_dout0;
    ...
    reg_file_4_1_address0 <= reg_file_4_1_addr_reg_188_pp0_iter1_reg;
    reg_file_4_1_address1 <= zext_ln137_fu_148_p1(11 - 1 downto 0);
    ...
    reg_file_4_1_d0 <= grp_fu_176_p_dout0;
    ...
    tmp_fu_122_p3 <= ap_sig_allocacmp_j(6 downto 6);
    zext_ln137_fu_148_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln_fu_140_p3),64));
end behav;
