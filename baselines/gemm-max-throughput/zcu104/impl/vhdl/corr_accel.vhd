...
architecture behav of corr_accel is 
    ...
    "corr_accel_corr_accel,hls_ip_2022_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xczu7ev-ffvc1156-2-e,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=7.300000,HLS_SYN_LAT=150432,HLS_SYN_TPT=none,HLS_SYN_MEM=32,HLS_SYN_DSP=0,HLS_SYN_FF=2605,HLS_SYN_LUT=7691,HLS_VERSION=2022_2}";
...
begin
    ...
    reg_file_8_address1_assign_proc : process(grp_recv_data_burst_fu_185_reg_file_4_0_address1, grp_compute_fu_208_reg_file_4_0_address1, grp_send_data_burst_fu_220_reg_file_4_0_address1, ap_CS_fsm_state3, ap_CS_fsm_state6, ap_CS_fsm_state9)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state9)) then 
    ...
    reg_file_8_ce1_assign_proc : process(grp_recv_data_burst_fu_185_reg_file_4_0_ce1, grp_compute_fu_208_reg_file_4_0_ce1, grp_send_data_burst_fu_220_reg_file_4_0_ce1, ap_CS_fsm_state3, ap_CS_fsm_state6, ap_CS_fsm_state9)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state9)) then 
    ...
    reg_file_9_address1_assign_proc : process(grp_recv_data_burst_fu_185_reg_file_4_1_address1, grp_compute_fu_208_reg_file_4_1_address1, grp_send_data_burst_fu_220_reg_file_4_1_address1, ap_CS_fsm_state3, ap_CS_fsm_state6, ap_CS_fsm_state9)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state9)) then 
    ...
    reg_file_9_ce1_assign_proc : process(grp_recv_data_burst_fu_185_reg_file_4_1_ce1, grp_compute_fu_208_reg_file_4_1_ce1, grp_send_data_burst_fu_220_reg_file_4_1_ce1, ap_CS_fsm_state3, ap_CS_fsm_state6, ap_CS_fsm_state9)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state9)) then 
