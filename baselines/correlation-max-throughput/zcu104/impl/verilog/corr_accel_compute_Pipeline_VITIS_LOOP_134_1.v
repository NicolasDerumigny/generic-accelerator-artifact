...
module corr_accel_compute_Pipeline_VITIS_LOOP_134_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [63:0] zext_ln138_1_fu_142_p1;
reg   [6:0] j_fu_46;
wire   [6:0] add_ln134_fu_148_p2;
wire    ap_loop_init;
reg   [6:0] ap_sig_allocacmp_j_11;
wire   [4:0] lshr_ln_fu_120_p4;
wire   [4:0] or_ln138_fu_136_p2;
reg    ap_done_reg;
...
always @ (*) begin
    if (((tmp_fu_112_p3 == 1'd1) & (1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
...
always @ (*) begin
    if (((tmp_fu_112_p3 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
...
assign add_ln134_fu_148_p2 = (ap_sig_allocacmp_j_11 + 7'd4);
...
always @ (*) begin
    ap_enable_operation_18 = (tmp_fu_112_p3 == 1'd0);
end

always @ (*) begin
    ap_enable_operation_20 = (tmp_fu_112_p3 == 1'd0);
end

always @ (*) begin
    ap_enable_operation_24 = (tmp_fu_112_p3 == 1'd0);
end

always @ (*) begin
    ap_enable_operation_26 = (tmp_fu_112_p3 == 1'd0);
end
...
assign lshr_ln_fu_120_p4 = {{ap_sig_allocacmp_j_11[5:1]}};

assign or_ln138_fu_136_p2 = (lshr_ln_fu_120_p4 | 5'd1);

assign reg_file_4_0_address0 = zext_ln138_1_fu_142_p1;

assign reg_file_4_0_address1 = zext_ln138_fu_130_p1;

assign reg_file_4_0_d0 = 16'd0;

assign reg_file_4_0_d1 = 16'd0;

assign reg_file_4_1_address0 = zext_ln138_1_fu_142_p1;

assign reg_file_4_1_address1 = zext_ln138_fu_130_p1;

assign reg_file_4_1_d0 = 16'd0;

assign reg_file_4_1_d1 = 16'd0;

assign tmp_fu_112_p3 = ap_sig_allocacmp_j_11[32'd6];

assign zext_ln138_1_fu_142_p1 = or_ln138_fu_136_p2;

assign zext_ln138_fu_130_p1 = lshr_ln_fu_120_p4;

endmodule //corr_accel_compute_Pipeline_VITIS_LOOP_134_1
