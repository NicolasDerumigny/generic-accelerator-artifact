...
set portList { 
	...
	{ reg_file_3_1_we0 sc_out sc_logic 1 signal 3 } 
	{ reg_file_3_1_d0 sc_out sc_lv 16 signal 3 } 
}
set NewPortList {[ 
...
set ArgLastReadFirstWriteLatency {
	compute {
		...
		reg_file_3_0 {Type O LastRead -1 FirstWrite 1}
		reg_file_3_1 {Type O LastRead -1 FirstWrite 1}}}
