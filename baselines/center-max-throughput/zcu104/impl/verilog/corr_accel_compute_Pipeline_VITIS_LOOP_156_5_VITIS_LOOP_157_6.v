...
module corr_accel_compute_Pipeline_VITIS_LOOP_156_5_VITIS_LOOP_157_6 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [0:0] tmp_reg_316;
wire   [4:0] lshr_ln9_fu_193_p4;
reg   [4:0] lshr_ln9_reg_321;
reg   [10:0] reg_file_2_0_addr_reg_336;
reg   [10:0] reg_file_2_0_addr_reg_336_pp0_iter2_reg;
reg   [15:0] reg_file_4_0_load_reg_342;
reg   [10:0] reg_file_2_1_addr_reg_347;
reg   [10:0] reg_file_2_1_addr_reg_347_pp0_iter2_reg;
reg   [15:0] reg_file_4_1_load_reg_353;
wire   [15:0] val2_fu_272_p1;
wire   [15:0] val2_1_fu_286_p1;
wire   [63:0] zext_ln161_fu_203_p1;
wire    ap_block_pp0_stage0;
wire   [63:0] zext_ln161_1_fu_252_p1;
reg   [6:0] j_6_fu_60;
wire   [6:0] add_ln157_fu_209_p2;
wire    ap_loop_init;
reg   [6:0] ap_sig_allocacmp_j_6_load;
reg   [6:0] i_6_fu_64;
wire   [6:0] select_ln161_1_fu_234_p3;
reg   [11:0] indvar_flatten6_fu_68;
wire   [11:0] add_ln156_fu_168_p2;
reg   [11:0] ap_sig_allocacmp_indvar_flatten6_load;
wire   [6:0] select_ln161_fu_185_p3;
wire   [6:0] add_ln156_1_fu_228_p2;
wire   [5:0] trunc_ln161_fu_241_p1;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln156_fu_162_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        reg_file_2_0_addr_reg_336 <= zext_ln161_1_fu_252_p1;
        reg_file_2_1_addr_reg_347 <= zext_ln161_1_fu_252_p1;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln156_fu_162_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        lshr_ln9_reg_321 <= {{select_ln161_fu_185_p3[5:1]}};
        tmp_reg_316 <= ap_sig_allocacmp_j_6_load[32'd6];
    end
end
...
always @ (*) begin
    if (((icmp_ln156_fu_162_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln156_1_fu_228_p2 = (i_6_fu_64 + 7'd1);

assign add_ln156_fu_168_p2 = (ap_sig_allocacmp_indvar_flatten6_load + 12'd1);

assign add_ln157_fu_209_p2 = (select_ln161_fu_185_p3 + 7'd2);

assign add_ln1_fu_245_p3 = {{trunc_ln161_fu_241_p1}, {lshr_ln9_reg_321}};
...
assign grp_fu_94_p_din0 = reg_file_2_0_q1;

assign grp_fu_94_p_din1 = val2_fu_272_p1;

assign grp_fu_98_p_ce = 1'b1;

assign grp_fu_98_p_din0 = reg_file_2_1_q1;

assign grp_fu_98_p_din1 = val2_1_fu_286_p1;

assign icmp_ln156_fu_162_p2 = ((ap_sig_allocacmp_indvar_flatten6_load == 12'd2048) ? 1'b1 : 1'b0);

assign lshr_ln9_fu_193_p4 = {{select_ln161_fu_185_p3[5:1]}};

assign reg_file_2_0_address0 = reg_file_2_0_addr_reg_336_pp0_iter2_reg;

assign reg_file_2_0_address1 = zext_ln161_1_fu_252_p1;

assign reg_file_2_0_d0 = grp_fu_94_p_dout0;

assign reg_file_2_1_address0 = reg_file_2_1_addr_reg_347_pp0_iter2_reg;

assign reg_file_2_1_address1 = zext_ln161_1_fu_252_p1;

assign reg_file_2_1_d0 = grp_fu_98_p_dout0;

assign reg_file_4_0_address0 = zext_ln161_fu_203_p1;

assign reg_file_4_1_address0 = zext_ln161_fu_203_p1;

assign select_ln161_1_fu_234_p3 = ((tmp_reg_316[0:0] == 1'b1) ? add_ln156_1_fu_228_p2 : i_6_fu_64);

assign select_ln161_fu_185_p3 = ((tmp_fu_177_p3[0:0] == 1'b1) ? 7'd0 : ap_sig_allocacmp_j_6_load);

assign tmp_fu_177_p3 = ap_sig_allocacmp_j_6_load[32'd6];

assign trunc_ln161_fu_241_p1 = select_ln161_1_fu_234_p3[5:0];
...
assign zext_ln161_1_fu_252_p1 = add_ln1_fu_245_p3;

assign zext_ln161_fu_203_p1 = lshr_ln9_fu_193_p4;

endmodule //corr_accel_compute_Pipeline_VITIS_LOOP_156_5_VITIS_LOOP_157_6
