set moduleName compute_Pipeline_VITIS_LOOP_134_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {compute_Pipeline_VITIS_LOOP_134_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ reg_file_4_1 int 16 regular {array 2048 { 0 0 } 0 1 }  }
	{ reg_file_4_0 int 16 regular {array 2048 { 0 0 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "reg_file_4_1", "interface" : "memory", "bitwidth" : 16, "direction" : "WRITEONLY"} , 
 	{ "Name" : "reg_file_4_0", "interface" : "memory", "bitwidth" : 16, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ reg_file_4_1_we1 sc_out sc_logic 1 signal 0 } 
	{ reg_file_4_1_d1 sc_out sc_lv 16 signal 0 } 
	...
	{ reg_file_4_0_we1 sc_out sc_logic 1 signal 1 } 
	{ reg_file_4_0_d1 sc_out sc_lv 16 signal 1 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	reg_file_4_1 { ap_memory {  { reg_file_4_1_address0 mem_address 1 11 }  { reg_file_4_1_ce0 mem_ce 1 1 }  { reg_file_4_1_we0 mem_we 1 1 }  { reg_file_4_1_d0 mem_din 1 16 }  { reg_file_4_1_address1 MemPortADDR2 1 11 }  { reg_file_4_1_ce1 MemPortCE2 1 1 }  { reg_file_4_1_we1 MemPortWE2 1 1 }  { reg_file_4_1_d1 MemPortDIN2 1 16 } } }
	reg_file_4_0 { ap_memory {  { reg_file_4_0_address0 mem_address 1 11 }  { reg_file_4_0_ce0 mem_ce 1 1 }  { reg_file_4_0_we0 mem_we 1 1 }  { reg_file_4_0_d0 mem_din 1 16 }  { reg_file_4_0_address1 MemPortADDR2 1 11 }  { reg_file_4_0_ce1 MemPortCE2 1 1 }  { reg_file_4_0_we1 MemPortWE2 1 1 }  { reg_file_4_0_d1 MemPortDIN2 1 16 } } }
}
