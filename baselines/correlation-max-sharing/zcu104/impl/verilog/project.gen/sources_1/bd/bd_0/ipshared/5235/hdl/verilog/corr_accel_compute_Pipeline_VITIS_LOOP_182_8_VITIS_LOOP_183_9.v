...
wire   [4:0] indvars_iv159_udiv_mid2_fu_217_p4;
...
assign add_ln2_fu_235_p3 = {{trunc_ln189_fu_231_p1}, {indvars_iv159_udiv_mid2_fu_217_p4}};
...
assign grp_fu_292_p_din0 = val1_fu_272_p4;

assign grp_fu_292_p_din1 = val1_fu_272_p4;

assign icmp_ln182_fu_171_p2 = ((ap_sig_allocacmp_indvar_flatten13_load == 13'd4096) ? 1'b1 : 1'b0);

assign icmp_ln183_fu_189_p2 = ((ap_sig_allocacmp_i_8_load == 7'd64) ? 1'b1 : 1'b0);

assign indvars_iv159_udiv_mid2_fu_217_p4 = {{select_ln182_1_fu_209_p3[5:1]}};
...
assign select_ln182_fu_195_p3 = ((icmp_ln183_fu_189_p2[0:0] == 1'b1) ? 7'd0 : ap_sig_allocacmp_i_8_load);
