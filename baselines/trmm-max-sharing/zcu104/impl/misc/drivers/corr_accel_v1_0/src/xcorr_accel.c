...
void XCorr_accel_Set_data_in(XCorr_accel *InstancePtr, u64 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XCorr_accel_WriteReg(InstancePtr->Control_BaseAddress, XCORR_ACCEL_CONTROL_ADDR_DATA_IN_DATA, (u32)(Data));
    XCorr_accel_WriteReg(InstancePtr->Control_BaseAddress, XCORR_ACCEL_CONTROL_ADDR_DATA_IN_DATA + 4, (u32)(Data >> 32));
}

u64 XCorr_accel_Get_data_in(XCorr_accel *InstancePtr) {
    u64 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XCorr_accel_ReadReg(InstancePtr->Control_BaseAddress, XCORR_ACCEL_CONTROL_ADDR_DATA_IN_DATA);
    Data += (u64)XCorr_accel_ReadReg(InstancePtr->Control_BaseAddress, XCORR_ACCEL_CONTROL_ADDR_DATA_IN_DATA + 4) << 32;
    return Data;
}

void XCorr_accel_Set_data_out(XCorr_accel *InstancePtr, u64 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XCorr_accel_WriteReg(InstancePtr->Control_BaseAddress, XCORR_ACCEL_CONTROL_ADDR_DATA_OUT_DATA, (u32)(Data));
    XCorr_accel_WriteReg(InstancePtr->Control_BaseAddress, XCORR_ACCEL_CONTROL_ADDR_DATA_OUT_DATA + 4, (u32)(Data >> 32));
}

u64 XCorr_accel_Get_data_out(XCorr_accel *InstancePtr) {
    u64 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XCorr_accel_ReadReg(InstancePtr->Control_BaseAddress, XCORR_ACCEL_CONTROL_ADDR_DATA_OUT_DATA);
    Data += (u64)XCorr_accel_ReadReg(InstancePtr->Control_BaseAddress, XCORR_ACCEL_CONTROL_ADDR_DATA_OUT_DATA + 4) << 32;
    return Data;
}
