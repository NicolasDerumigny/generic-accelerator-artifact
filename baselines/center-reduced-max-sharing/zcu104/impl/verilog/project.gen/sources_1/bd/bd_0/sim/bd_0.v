...
module bd_0
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.DATA_IN_ADDRESS0 DATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.DATA_IN_ADDRESS0, LAYERED_METADATA undef" *) output [13:0]data_in_address0;
  output data_in_ce0;
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.DATA_IN_Q0 DATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.DATA_IN_Q0, LAYERED_METADATA undef" *) input [63:0]data_in_q0;
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.DATA_OUT_ADDRESS0 DATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.DATA_OUT_ADDRESS0, LAYERED_METADATA undef" *) output [13:0]data_out_address0;
  output data_out_ce0;
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.DATA_OUT_D0 DATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.DATA_OUT_D0, LAYERED_METADATA undef" *) output [63:0]data_out_d0;
  output data_out_we0;
  ...
  wire [63:0]data_in_q0_0_1;
  wire [13:0]hls_inst_data_in_address0;
  wire hls_inst_data_in_ce0;
  wire [13:0]hls_inst_data_out_address0;
  wire hls_inst_data_out_ce0;
  wire [63:0]hls_inst_data_out_d0;
  wire hls_inst_data_out_we0;
  ...
  assign data_in_address0[13:0] = hls_inst_data_in_address0;
  assign data_in_ce0 = hls_inst_data_in_ce0;
  assign data_in_q0_0_1 = data_in_q0[63:0];
  assign data_out_address0[13:0] = hls_inst_data_out_address0;
  assign data_out_ce0 = hls_inst_data_out_ce0;
  assign data_out_d0[63:0] = hls_inst_data_out_d0;
  assign data_out_we0 = hls_inst_data_out_we0;
  ...
  bd_0_hls_inst_0 hls_inst
       (.ap_clk(ap_clk_0_1),
        ...
        .counter(counter_0_1),
        .data_in_address0(hls_inst_data_in_address0),
        .data_in_ce0(hls_inst_data_in_ce0),
        .data_in_q0(data_in_q0_0_1),
        .data_out_address0(hls_inst_data_out_address0),
        .data_out_ce0(hls_inst_data_out_ce0),
        .data_out_d0(hls_inst_data_out_d0),
        .data_out_we0(hls_inst_data_out_we0),
