set moduleName compute_Pipeline_VITIS_LOOP_204_12
set isTopModule 0
...
set C_modelArgMapList {[ 
	{ "Name" : "reg_file_5_1", "interface" : "memory", "bitwidth" : 16, "direction" : "READWRITE"} , 
 	...
 	{ "Name" : "val2_2", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ val2_2 sc_in sc_lv 16 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "val2_2", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "val2_2", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	val2_2 { ap_none {  { val2_2 in_data 0 16 } } }
}
