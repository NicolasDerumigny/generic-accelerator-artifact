set SynModuleInfo {
  ...
  {SRCNAME compute_Pipeline_VITIS_LOOP_176_3 MODELNAME compute_Pipeline_VITIS_LOOP_176_3 RTLNAME corr_accel_compute_Pipeline_VITIS_LOOP_176_3
    SUBMODULES {
      ...
      {MODELNAME corr_accel_hsub_16ns_16ns_16_2_full_dsp_1 RTLNAME corr_accel_hsub_16ns_16ns_16_2_full_dsp_1 BINDTYPE op TYPE hsub IMPL fulldsp LATENCY 1 ALLOW_PRAGMA 1}
      ...
      {MODELNAME corr_accel_mux_114_16_1_1 RTLNAME corr_accel_mux_114_16_1_1 BINDTYPE op TYPE mux IMPL auto LATENCY 0 ALLOW_PRAGMA 1}
      {MODELNAME corr_accel_mux_124_16_1_1 RTLNAME corr_accel_mux_124_16_1_1 BINDTYPE op TYPE mux IMPL auto LATENCY 0 ALLOW_PRAGMA 1}
    }
  }
  {SRCNAME compute MODELNAME compute RTLNAME corr_accel_compute
    SUBMODULES {
      ...
      {MODELNAME corr_accel_mux_134_16_1_1 RTLNAME corr_accel_mux_134_16_1_1 BINDTYPE op TYPE mux IMPL auto LATENCY 0 ALLOW_PRAGMA 1}
    }
  }
  {SRCNAME send_data_burst MODELNAME send_data_burst RTLNAME corr_accel_send_data_burst
    SUBMODULES {
      {MODELNAME corr_accel_mux_265_16_1_1 RTLNAME corr_accel_mux_265_16_1_1 BINDTYPE op TYPE mux IMPL auto LATENCY 0 ALLOW_PRAGMA 1}
    }
  }
